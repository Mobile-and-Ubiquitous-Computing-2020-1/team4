 ...
 */
data class POI(val id: String, val name: String, val lat: Double, val long: Double, val distance: Int, val address: String, val category: String, val description: String = "No description yet.") {
}
